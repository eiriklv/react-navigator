...
var Navigator = (function (_React$Component) {
  ...
  _createClass(Navigator, [{
    ...
    value: function _enableScene(sceneIndex) {
      ...
      var sceneStyle = Object.assign({}, styles.baseScene, this.props.sceneStyle);
    ...
    key: '_transitionTo',
    value: function _transitionTo(index) {
    ...
    value: function replaceAtIndex(route, index, cb) {
      ...
      this.setState({
        ...
        if (index === _this2.state.presentedIndex) {
          _this2._emitDidFocus(route);
        }
        cb && cb();
      });
    }
    ...
    value: function resetTo(route) {
      ...
      this.replaceAtIndex(route, 0, function () {
        ...
        if (_this3.state.presentedIndex > 0) {
          _this3._popN(_this3.state.presentedIndex);
        }
      });
    }
  }, {
    ...
    value: function render() {
      ...
      var scenes = this.state.routeStack.map(function (route, index) {
        var renderedScene = _this4._renderedSceneMap.has(route) && index !== _this4.state.presentedIndex ? _this4._renderedSceneMap.get(route) : _this4._renderScene(route, index);
